...
module.exports = {
  ...
  safelist: [
    'bg-background', 'bg-card', 'text-text', 'text-primary', 'text-accent', 'text-accent2', 'text-accent3',
    'border-border', 'bg-accent', 'bg-accent2', 'bg-accent3', 'bg-primary',
    'text-error', 'text-success', 'bg-error', 'bg-success'
  ],
  theme: {
    extend: {
      colors: {
