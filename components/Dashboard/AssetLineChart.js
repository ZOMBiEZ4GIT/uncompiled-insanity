    ...
    <>
      ...
      <ResponsiveContainer width="100%" height={200}>
        <LineChart data={data}>
          ...
          <Tooltip contentStyle={{ background: 'rgba(36,37,46,0.95)', color: '#fff', borderRadius: 8 }} labelStyle={{ color: '#fff' }} />
          <Legend />
          <Line type="monotone" dataKey="amount" stroke={color || "#8884d8"} strokeWidth={3} dot={{ r: 4 }} activeDot={{ r: 7 }} />
        </LineChart>
      </ResponsiveContainer>
    </>
  );
