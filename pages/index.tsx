  ...
  return (
    <main className="min-h-screen w-full flex flex-col items-center bg-gradient-to-br from-[#18181B] via-[#23234b] to-[#1a1a2e] py-10 px-2">
      <div className="w-full max-w-6xl flex flex-col gap-12 px-2">
        <h1 className="text-4xl font-extrabold text-center text-sky-100 mb-6 tracking-tight drop-shadow">
          Insanity Dashboard
        </h1>
        {/* Top grid: Pie + Budget */}
        ...
        <section className="flex flex-col items-center w-full">
          ...
          {step === 'form' && category === 'crypto' && (
            ...
            >
              <h3 className="text-base font-semibold mb-1 text-sky-400">
                Add Crypto Transaction
              </h3>
              <input
                className="w-full px-3 py-2 rounded border border-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-400"
              ...
              />
              <button
                className="w-full mt-2 py-2 px-4 rounded bg-sky-500 text-white font-bold hover:bg-sky-600 transition"
                type="submit"
              >
                Add
              </button>
          ...
          {step === 'result' && result && (
            <div
              className={`p-4 rounded-lg ${result.success ? 'bg-green-600' : 'bg-red-600'} text-white mb-4 shadow`}
            >
              {result.message}
            </div>
          )}
          {step === 'result' && (
            <button
              className="w-full py-2 px-4 rounded bg-sky-500 text-white font-bold hover:bg-sky-600 transition"
              onClick={handleReset}
            >
              Add Another
            </button>
